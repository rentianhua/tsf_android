...
import com.dumu.housego.util.ChengJiaoRentingJSONParse;
import com.dumu.housego.util.ChengJiaoRentingJSONParse2;
...
public class ChengJiaoRtModel implements IChengJiaoRTModel {
    ...
    public void ChengJiaoRT(final String username, final String userid, final String table, final AsycnCallBack back) {
        ...
        CommonRequest request = new CommonRequest(Method.POST, url, new Listener<String>() {
            ...
            public void onResponse(String response) {
                if (response != null) {
                    try {
                        List<RentingRecommendData> ershoudetails = ChengJiaoRentingJSONParse2.parseSearch(response);
