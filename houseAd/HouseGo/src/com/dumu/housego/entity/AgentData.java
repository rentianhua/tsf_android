...
public class AgentData {
    ...
    public Integer fb_rate;
    public Integer chengjiao_count;
    public Integer weituo_count;
    public Integer daikan_count;

    public AgentData() {
        super();
    }

    public AgentData(String sfzpic, String mainarea, String leixing, String dengji, String biaoqian, String userid,
                     String cardnumber, String realname, String jiav, String worktime, String sex, String fans, String loginnum,
                     String about, String heat, String password, String amount, String ctel, String vip, String share,
    ...
    public String toString() {
        return "AgentData [sfzpic=" + sfzpic + ", mainarea=" + mainarea + ", leixing=" + leixing + ", dengji=" + dengji
                + ", biaoqian=" + biaoqian + ", userid=" + userid + ", cardnumber=" + cardnumber + ", realname="
                + realname + ", jiav=" + jiav + ", worktime=" + worktime + ", sex=" + sex + ", fans=" + fans
                + ", loginnum=" + loginnum + ", about=" + about + ", heat=" + heat + ", password=" + password
                + ", amount=" + amount + ", ctel=" + ctel + ", vip=" + vip + ", share=" + share + ", username="
                + username + ", deptid=" + deptid + ", regip=" + regip + ", encrypt=" + encrypt + ", regdate=" + regdate
                + ", vtel=" + vtel + ", groupid=" + groupid + ", overduedate=" + overduedate + ", lastdate=" + lastdate
