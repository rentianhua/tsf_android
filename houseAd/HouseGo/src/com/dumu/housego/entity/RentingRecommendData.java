...
public class RentingRecommendData {
	...
	public RentingRecommendData(String ceng,String zongceng,String zonghe,String id, String catid, String module, String modelid, String listorder,
	...
	public String toString() {
		return "RentingRecommendData [id=" + id + ", catid=" + catid + ", module=" + module + ", modelid=" + modelid
				...
				+ synedit + ", ceng=" + ceng + ", zongceng=" + zongceng + ", title=" + title + ", province=" + province
				+ ", xiaoquname=" + xiaoquname + ", zujin=" + zujin + ", mianji=" + mianji + ", ting=" + ting + ", shi="
				+ shi + ", thumb=" + thumb + ", city=" + city + ", area=" + area + ", posid=" + posid + ", style="
				+ style + ", url=" + url + ", provincename=" + provincename + ", cityname=" + cityname + ", areaname="
				+ areaname + ", chaoxiang=" + chaoxiang + ", biaoqian=" + biaoqian + ", wei=" + wei + ", zaizu=" + zaizu
				+ ", lock=" + lock + ", zonghe=" + zonghe + "]";
	}
