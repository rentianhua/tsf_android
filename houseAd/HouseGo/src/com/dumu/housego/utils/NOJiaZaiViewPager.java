...
* 
*      http:import java.util.ArrayList;
import java.util.Collections;
import java.util.Comparator;
...
*/  
public class NOJiaZaiViewPager extends ViewGroup {  
   ...
   public NOJiaZaiViewPager(Context context) {  
       super(context);  
       initViewPager();  
   }  
 
   public NOJiaZaiViewPager(Context context, AttributeSet attrs) {  
       super(context, attrs);  
       initViewPager();  
   }  
