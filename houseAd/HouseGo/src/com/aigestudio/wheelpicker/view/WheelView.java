...
import com.dumu.housego.R.color;
...
/**
 * 滚轮实际的控制类 Controller of WheelView
 *
...
class WheelView extends View {
	...
	WheelView(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		if (idData == 0)
			idData = R.array.WheelArrayDefault;
		...
		textColor = a.getColor(R.styleable.WheelPicker_wheel_text_color,color.Dingyiblue);
