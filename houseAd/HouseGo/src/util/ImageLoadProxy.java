...
import com.dumu.housego.BuildConfig;
...
public class ImageLoadProxy {
	 ...
	 */
	  ...
	  * @param target
	  */
	 public static void displayHeadIcon(String url, ImageView target,SimpleImageLoadingListener loadingListener) {
		 imageLoader.displayImage(url, target, getOptions4Header(),loadingListener);
	  ...
	  * @param loadingListener
	  */
	 public static void displayHeadIconList(String url, ImageView target, int loadingResource, SimpleImageLoadingListener loadingListener) {
